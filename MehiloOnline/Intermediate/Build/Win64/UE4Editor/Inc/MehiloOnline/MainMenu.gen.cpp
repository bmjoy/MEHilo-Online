...
#include "MehiloOnline/MenuSystem/MainMenu.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	MEHILOONLINE_API UScriptStruct* Z_Construct_UScriptStruct_FServerData();
	UPackage* Z_Construct_UPackage__Script_MehiloOnline();
	MEHILOONLINE_API UClass* Z_Construct_UClass_UMainMenu_NoRegister();
	MEHILOONLINE_API UClass* Z_Construct_UClass_UMainMenu();
	MEHILOONLINE_API UClass* Z_Construct_UClass_UMenuWidget();
	MEHILOONLINE_API UFunction* Z_Construct_UFunction_UMainMenu_Exit();
	MEHILOONLINE_API UFunction* Z_Construct_UFunction_UMainMenu_HostServer();
	MEHILOONLINE_API UFunction* Z_Construct_UFunction_UMainMenu_JoinServer();
	MEHILOONLINE_API UFunction* Z_Construct_UFunction_UMainMenu_OpenHostMenu();
	MEHILOONLINE_API UFunction* Z_Construct_UFunction_UMainMenu_OpenJoinMenu();
	MEHILOONLINE_API UFunction* Z_Construct_UFunction_UMainMenu_OpenMainMenu();
...
class UScriptStruct* FServerData::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern MEHILOONLINE_API uint32 Get_Z_Construct_UScriptStruct_FServerData_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FServerData, Z_Construct_UPackage__Script_MehiloOnline(), TEXT("ServerData"), sizeof(FServerData), Get_Z_Construct_UScriptStruct_FServerData_CRC());
	}
	return Singleton;
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FServerData(FServerData::StaticStruct, TEXT("/Script/MehiloOnline"), TEXT("ServerData"), false, nullptr, nullptr);
static struct FScriptStruct_MehiloOnline_StaticRegisterNativesFServerData
{
	FScriptStruct_MehiloOnline_StaticRegisterNativesFServerData()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("ServerData")),new UScriptStruct::TCppStructOps<FServerData>);
	}
} ScriptStruct_MehiloOnline_StaticRegisterNativesFServerData;
	...
	UScriptStruct* Z_Construct_UScriptStruct_FServerData()
	{
		...
		UPackage* Outer = Z_Construct_UPackage__Script_MehiloOnline();
	...
	uint32 Get_Z_Construct_UScriptStruct_FServerData_CRC() { return 3901937782U; }
	void UMainMenu::StaticRegisterNativesUMainMenu()
	{
		UClass* Class = UMainMenu::StaticClass();
		static const FNameNativePtrPair Funcs[] = {
			{ "Exit", &UMainMenu::execExit },
	...
	struct Z_Construct_UFunction_UMainMenu_Exit_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMainMenu_Exit_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "MenuSystem/MainMenu.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UMainMenu_Exit_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMainMenu, "Exit", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00040401, 0, nullptr, 0, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UMainMenu_Exit_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UMainMenu_Exit_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UMainMenu_Exit()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UMainMenu_Exit_Statics::FuncParams);
		}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMainMenu_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMainMenu_Exit, "Exit" }, // 3725597425
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMainMenu_Statics::NewProp_ConfirmHostMenuButton_MetaData[] = {
		...
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "MenuSystem/MainMenu.h" },
		{ "ToolTip", "the actual host button in the host menu." },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMainMenu_Statics::NewProp_ConfirmJoinMenuButton_MetaData[] = {
		...
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "MenuSystem/MainMenu.h" },
		{ "ToolTip", "the actual join button in the join menu." },
	};
#endif
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMainMenu_Statics::NewProp_ExitButton = { UE4CodeGen_Private::EPropertyClass::Object, "ExitButton", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0040000000080008, 1, nullptr, STRUCT_OFFSET(UMainMenu, ExitButton), Z_Construct_UClass_UButton_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMainMenu_Statics::NewProp_ExitButton_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMainMenu_Statics::NewProp_ExitButton_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMainMenu, 3161294731);
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMainMenu(Z_Construct_UClass_UMainMenu, &UMainMenu::StaticClass, TEXT("/Script/MehiloOnline"), TEXT("UMainMenu"), false, nullptr, nullptr, nullptr);
